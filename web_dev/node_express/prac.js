...
// let hash=c.createHash('sha256').update("sam").digest("hex")
// let hash1=c.createHash('sha256').update("sam")

// console.log("3",hash,hash1)


// const d=c.randomBytes(16).toString('hex')
// console.log(d)
