...
"""
from phpinfofileleaks.includes import bot
...
from phpinfofileleaks.includes import writefile
        ...
        with requests.Session() as session:
            ...
            for endpoint in payreq.text.splitlines():
                ...
                try:
                    ...
                    if response.status_code == 200 and "PHP Extension" in response.text and "PHP Version" in response.text:
                        outputprint = (
